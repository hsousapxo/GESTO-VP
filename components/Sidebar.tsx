    ...
    return (
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto py-5 custom-scrollbar h-[calc(100vh-81px)]">
                ...
                {/* Agente PF008 Section */}
                <MenuSection title="Agente PF008" icon={<User className="w-4 h-4 text-green-500" />} defaultOpen={true} isCollapsed={isCollapsed} onExpand={handleExpand}>
                    <MenuItem 
                ...
                <MenuSection title="GS PF008" icon={<FolderOpen className="w-4 h-4 text-yellow-500" />} defaultOpen={true} isCollapsed={isCollapsed} onExpand={handleExpand}>
                    ...
                    {/* Folder: Legislação PF008 */}
                    <SubMenu label="Legislação PF008" icon={<BookOpen className="w-4 h-4 text-blue-400" />} isCollapsed={isCollapsed}>
                        <MenuItem 
